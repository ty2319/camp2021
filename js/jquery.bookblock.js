...
(function($, window, undefined) {
	...
	*/
	...
	$.BookBlock.prototype = {
		...
		next: function() {
			this._action('next');
			$('.bb-page:eq(1) > div:first').css('z-index' , 2000).animate({zIndex : 0} , 800 , function() {
			$('.bb-page:eq(1) > div:eq(1)').css('z-index' , 0).animate({zIndex : 2000} , 800)});
		},
		// public method: flips back
		prev: function() {
			this._action('prev');
			$('.bb-page:eq(1) > div:first').css('z-index' , 0).animate({zIndex : 2000} , 800);
			$('.bb-page:eq(1) > div:eq(1)').css('z-index' , 2000).animate({zIndex : 0} , 800);
		},
		...
		jump: function(page) {
			...
			if (page > this.current) {
				this._action('next' , page);
				$('.bb-page:eq(1) > div:first').css('z-index' , 2000).animate({zIndex : 0} , 800);
				$('.bb-page:eq(1) > div:eq(1)').css('z-index' , 0).animate({zIndex : 2000} , 800);
			} else if (page < this.current) {
				this._action('prev' , page);
				$('.bb-page:eq(1) > div:first').css('z-index' , 0).animate({zIndex : 2000} , 800);
				$('.bb-page:eq(1) > div:eq(1)').css('z-index' , 2000).animate({zIndex : 0} , 800);
			}
